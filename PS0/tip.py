# In the United States, it’s customary to leave a tip for your server after dining in a restaurant, typically an
# amount equal to 15% or more of your meal’s cost. Not to worry, though, we’ve written a tip calculator for you, below!
#
...
# 0.15. Assume that the user will input values in the expected formats.
...
def percent_to_float(p):
    return 0.01 * round(float(p.removesuffix('%')))
